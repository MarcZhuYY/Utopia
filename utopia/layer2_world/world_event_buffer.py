...
class WorldEventBuffer:
    ...
    Example:
        ...
        >>> events = buffer.drain(tick_number=1)  # From Mutator
    """
    ...
    def drain(self, tick_number: Optional[int] = None) -> list["WorldEvent"]:
        """
    ...
    def drain_all(self) -> list["WorldEvent"]:
        """
    ...
    def get_events_by_type(self, tick_number: int) -> dict["EventType", list["WorldEvent"]]:
        """
